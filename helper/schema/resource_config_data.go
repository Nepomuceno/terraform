...
type ResourceConfigGetter interface {
	// Get is the only function available to ResourceValidateFuncs.
	//
	...
	Get(key string) (value interface{}, known bool)
}
...
// Get implements ResourceConfigGetter for ResourceConfigData
func (r *ResourceConfigData) Get(key string) (interface{}, bool) {
